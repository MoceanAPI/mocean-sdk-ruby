    ...
    module Message
      ...
      class VerifyRequestTest < MoceanTest::Test
        ...
        def test_xml_response
          ...
          fake = Minitest::Mock.new
          fake.expect :call, Moceansdk::Modules::Transmitter.new.format_response(file_content, true, '/verify/req'), [String, String, Hash]
